...
subtractComponent.getProperty("Property 1").data =1; 
subtractComponent.getProperty("Property 2").data =2;
subtractComponent.getPort("Result").onEmit(function(){
    if( subtractComponent.getPort("Result").getProperty("Property 3").data === 3){
        //Success. 
    } 
});
