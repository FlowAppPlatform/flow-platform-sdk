...
var subtractComponent = new SubtractComponent();
subtractComponent.getVariable("Variable 1").data =1; 
subtractComponent.getVariable("Variable 2").data =2;
subtractComponent.getPort("Result").onEmit(function(){
    if( subtractComponent.getPort("Result").getVariable("Variable 3").data === 3){
        //Success. 
    } 
});

// do not forget to Execute the component.
subtractComponent.execute();
